                    ...
                    <form>
                        <div className="form-group">
                            <div className="form-group-two">
                                <input type="text" name="نام" id="name" placeholder="نام" onChange={handlechnage}></input>
                                <input type="email" name="ایمیل" id="email" placeholder="پست الکترونیکی" onChange={handlechnage}></input>
                            </div>
                        </div>
                        <div className="form-group">
                            <div className="form-group-two">
                                <input type="text" name="موضوع" id="topic" placeholder="موضوع" onChange={handlechnage}></input>
                                <input type="text" name="سازمان" id="organization" placeholder="سازمان ( غیر ضروری )" onChange={handlechnage}></input>
                            </div>
                        </div>
                        <div className="form-group">
